...
class Car:
  ...
  def controls_update(self, CS: car.CarState, CC: car.CarControl, CC_SP: custom.CarControlSP):
    ...
    if self.sm.all_alive(['carControl']):
      ...
      if self.tss3_08a_proxy is not None:
        # MADS can own lateral control without ordinary selfdrive engagement.
        # Longitudinal authority remains gated by the normal enabled state.
        self.tss3_08a_proxy.set_control(CC.enabled or CC.latActive, CC.latActive, self.last_actuators_output.steeringAngleDeg,
